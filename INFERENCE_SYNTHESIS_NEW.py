...
gst_head_scores = np.array([[0.6, 0.23, 0.17], [0.3333, 0.3333, 0.3333], [0.4, 0.33, 0.27], [0.18, 0.36, 0.46],
                            [0.24, 0.38, 0.38], [0.05, 0.40, 0.55]])
gst_head_names = ("Token1High", "Equalized", "LinearDescendingOrder", "LinearAscendingOrder", "FirstDownOthersEqual",
                  "FirstAlmostZero")
