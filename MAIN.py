...
if __name__ == '__main__':
    ...
    training_prosody_features_path = '/homedtic/apeiro/LJSpeech-1.1/ProsodyFeatures/training_sparse_pitch_intensity_features/'
    validation_prosody_features_path = '/homedtic/apeiro/LJSpeech-1.1/ProsodyFeatures/validation_sparse_pitch_intensity_features/'

    output_directory = '/homedtic/apeiro/GST_Tacotron2_pitch_intensity_contour_sparse_SoftMax/outputs'
    # log_directory = '/homedtic/apeiro/GST_Tacotron2_pitch_prosody_dense/loggs'
    log_directory = '/tmp/loggs_directory_GST_pitch_intensity_softmax/'
